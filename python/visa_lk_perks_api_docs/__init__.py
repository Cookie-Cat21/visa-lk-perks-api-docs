"""Minimal unofficial HTTP client for Visa LK Perks API.
...
DEFAULT_UA = "visa-lk-perks-api-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/visa-lk-perks-api-docs; educational; polite)"
DEFAULT_BASE = "https://www.visa.com.lk"


class VisaLkPerksApiDocsClient:
    """Unofficial client — Visa LK Perks API."""
    ...
    def __enter__(self) -> "VisaLkPerksApiDocsClient":
        return self
    ...
    def portal_perks(self, index: int = 0, limit: int = 20, **kwargs: Any) -> Any:
        ...
        payload = dict({"siteId": "www.visa.com.lk", "pageRequest": {"index": 0, "limit": 20}})
